...
public class SimpleDistributedAvg {
    public static void main(String[] args) {
        ...
        if (rank == 0) {
            ...
            System.out.println("Final product: " + finalProduct/size);
        }
 ...
 *          set MPJ_HOME=C:\mpjexpress
        ...
        2.2) Compile your code with MPJ library
            javac -cp .;%MPJ_HOME%\lib\mpj.jar SimpleDistributedAvg.java
        2.3) Run using mpjrun
            mpjrun.bat -np 4 SimpleDistributedAvg
